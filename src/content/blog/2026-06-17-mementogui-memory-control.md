...
![MementoGUI 数据构造流水线：从原始 computer-use 视频到 frame/subgoal 标注、SFT 样本与 DPO 偏好对](/images/mementogui/figure-01.png)
...
![MementoGUI 系统总览：冻结 GUI action backbone，外接工作记忆与情景记忆控制器](/images/mementogui/figure-02.png)
...
![情景记忆库规模对 GUI-Odyssey 表现的影响：记忆越多并不自动等于更好，需要选择与过滤](/images/mementogui/figure-04.png)
...
![MementoGUI 主结果表：不同历史/记忆增强方式在 GUI-Odyssey、MM-Mind2Web 与 MementoGUI-Bench 上的对比](/images/mementogui/figure-03.png)
...
1. **长程 App 回归用例的 working memory ablation**  
