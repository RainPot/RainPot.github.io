...
![Orchard 在 SWE、GUI 和个人助理三类 agentic modeling 任务上的整体结果](/images/orchard-agentic-modeling/figure-1-performance.png)
...
![Orchard-GUI 与开源/闭源 computer-use agent 的参数量—成功率对比](/images/orchard-agentic-modeling/figure-1-performance-right.png)
...
![Orchard 框架总览：环境层、训练 recipe 和任务域彼此解耦](/images/orchard-agentic-modeling/figure-2-framework-overview.png)
...
![Orchard Env 的 Kubernetes-native 架构：冷路径走 API server，热路径直连 sandbox pod](/images/orchard-agentic-modeling/figure-3-env-architecture.png)
...
![Orchard-GUI 的任务过滤流程：从 292,092 个 raw tasks 到 15,601 个去重 seed tasks](/images/orchard-agentic-modeling/figure-4-task-filtering.png)
...
![Orchard-GUI seed tasks 的领域分布](/images/orchard-agentic-modeling/figure-5-domain-distribution.png)
...
![Orchard-GUI seed tasks 的热门网站覆盖率](/images/orchard-agentic-modeling/figure-6-website-coverage.png)
...
![Orchard-GUI 的 teacher rollout 结果：all-pass、mixed、all-fail 与 captcha 阻断](/images/orchard-agentic-modeling/figure-7-rollout-outcomes.png)
...
![按网站统计的 teacher success rate：不同网站的可自动化难度差异很大](/images/orchard-agentic-modeling/figure-8-per-website-success.png)
...
![Orchard-GUI 的 RL 曲线：SFT checkpoint 比 base model 初始化更稳定](/images/orchard-agentic-modeling/figure-9-gui-rl-curve.png)
...
![Orchard-Claw 的 RL 成功率曲线：个人助理任务中 train / validation success rate 同时上升](/images/orchard-agentic-modeling/figure-10-claw-success-rate.png)
...
![Orchard-Claw 的 episode length 曲线：训练后 agent 能参与更长的多轮任务](/images/orchard-agentic-modeling/figure-11-claw-episode-length.png)
