...
![SaaS-Bench Leaderboard：checkpoint score 与 resolved score 的巨大落差](/images/saas-bench/figure-01.png)
...
![SaaS-Bench 任务与系统覆盖：23 个真实 SaaS、6 个专业领域、106 个长程工作流](/images/saas-bench/figure-02.png)
...
![SaaS-Bench 评测闭环：agent 通过 browser-use 操作本地 SaaS，最终由 verifier 聚合 resolved/checkpoint 分数](/images/saas-bench/figure-04.png)
...
![SaaS-Bench 任务复杂度：nested task composition 与多应用任务占比](/images/saas-bench/figure-05.png)

![SaaS-Bench 任务结构分布：应用数量、嵌套组合与长程步骤共同拉高难度](/images/saas-bench/figure-06.png)
...
![SaaS-Bench 任务合成流水线：Builder–Challenger–Refiner 生成模板，再经过规则过滤与执行检查](/images/saas-bench/figure-07.png)
...
![SaaS-Bench pass@k：多次尝试能提高部分 checkpoint，但整体闭环仍然困难](/images/saas-bench/figure-09.png)
...
![动作分布与失败类型：Entity Missing 是主要失败，而不是简单 value mismatch](/images/saas-bench/figure-10.png)
...
![任务结构复杂度与得分关系：应用数量、操作长度、checkpoint 数都会压低稳定性](/images/saas-bench/figure-11.png)

![不同专业领域中的 agent 行为错误构成](/images/saas-bench/figure-12.png)

![checkpoint 位置越靠后，通过率越低，长程状态追踪持续衰减](/images/saas-bench/figure-13.png)

![每通过一个 checkpoint 所需步骤与整体通过率：长程成本和成功率之间存在明显张力](/images/saas-bench/figure-14.png)
